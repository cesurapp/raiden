...
export default [
  ...
  { name: 'type', label: 'Type', sortable: true, filter_input: 'select', export: true },
  ...
  { name: 'phone_country', label: 'Phone Country', sortable: true, export: true },
  ...
  { name: 'language', label: 'Language', sortable: true, export: true },
  { name: 'first_name', label: 'First Name', sortable: false, filter_input: 'input', export: true },
  { name: 'last_name', label: 'Last Name', sortable: false, filter_input: 'date', export: true },
