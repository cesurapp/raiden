  ...
  <q-dialog ref="dialog" :persistent='persistent'>
    <q-card class="q-dialog-plugin">
      ...
      <q-card-actions align="right">
        <q-btn v-if='cancel' flat color="red" :label="typeof cancel === 'string' ? $t(cancel) : $t('Cancel')" @click="onCancelClick"/>
...
export default {
  ...
  computed:{
    getIcon() {
      switch (this.icon) {
        case 'mdiDeleteOutline' : return mdiDeleteOutline;
        case 'mdiCheck' : return mdiCheck;
        case 'mdiClose' : return mdiClose;
        case 'mdiAlert' : return mdiAlert;
        case 'mdiInformationVariant' : return mdiInformationVariant;
        case 'mdiServerNetwork' : return mdiServerNetwork;
        default: return null;
      }
    }
  },
