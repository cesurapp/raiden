        ...
        $server->start(PHP_BINARY, array_replace_recursive(SwooleRunner::$options, [
            'http' => [
                ...
                'settings' => [
                    ...
                    Constant::OPTION_PID_FILE => $this->kernel->getProjectDir() . '/var/server.pid',
                    Constant::OPTION_LOG_FILE => sprintf('%s/var/log/%s_server.log', $this->kernel->getProjectDir(), $this->kernel->getEnvironment()),
                ]
            ],
            'app' => [
